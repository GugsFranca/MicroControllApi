package com.micro.parkingapi.controller;

import com.micro.parkingapi.DTO.ParkingSpotDto;
import com.micro.parkingapi.model.CarModel;
import com.micro.parkingapi.model.ParkingSpotModel;
import com.micro.parkingapi.service.CarService;
import com.micro.parkingapi.service.ParkingSpotService;
...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id") UUID id, @RequestBody @Valid ParkingSpotDto parkingSpotDto){
        ...
        CarModel carModel = parkingSpotModel.getCarModel();
        BeanUtils.copyProperties(parkingSpotDto.carModel(), carModel);
