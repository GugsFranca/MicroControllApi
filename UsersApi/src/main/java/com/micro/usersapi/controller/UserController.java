package com.micro.usersapi.controller;

import com.micro.usersapi.infra.TokenService;
import com.micro.usersapi.model.UserModel;
import com.micro.usersapi.model.UserModelDto;
import com.micro.usersapi.service.UserService;
...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> login(@RequestBody @Valid UserModelDto userModelDto) {
